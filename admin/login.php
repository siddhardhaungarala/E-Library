    ...
    if (isset($_POST['user_name']) && isset($_POST['password'])) {
        ...
        if ($rows > 0) {
            ...
            if ($_SESSION['account_type'] == 'ADMIN') {
                header('location: dashboard.php');
            } elseif ($_SESSION['account_type'] == 'SUB_ADMIN') {
                header('location: dashboard.php');
            } else {
    ...
    <style>
        ...
        *:focus {
        ...
        h1 {
            ...
            text-align: middle;
            left: 35%;
            text-shadow: 5px 5px 10px #0cc2ef;
            font-size: 450%;
        }
    </style>
</head>
...
<div class="wrapper fadeInDown">
    <div id="formContent" style="padding-top: 15px">
        <!-- Tabs Titles -->
        <h3>LECTURERS LOGIN</h3>

        <!-- Login Form -->
        <form action="" method="post" name="admin_login" id="admin_login">
            <input type="text" id="login" class="fadeIn second" name="user_name" placeholder="Enter Email ID">

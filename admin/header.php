...
<div id="mySidenav" class="sidenav">
    ...
    <a href="classes.php">Host a session</a>
    <a href="article.php">Documents</a>
    <a href="sub-admin.php">Add Admin</a>
    <a href="comment_list.php">Comments </a>
    <a href="http://localhost/elibrary/index.php" target="_blank" rel="noopener noreferrer">Home</a>

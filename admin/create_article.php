...
<form method="post" action="" enctype="multipart/form-data" style="border:1px solid #ccc">
    <div class="container">
        <div class="col-md-4 col-md-offset-4">
            <br><br>
            <h1><?php echo $edit ? "Edit" : "Upload"; ?> documents</h1>
            ...
            <label><b>Enter description about document Here</b></label>
            ...
            <label for="article_type"><b>Upload document here</b></label>
            ...
            <label for="article_type"><b>Select document sub-Category</b></label>
            ...
            <br>
            <label><b> Upload Documents</b></label><span class="glyphicon glyphicon-open-file"></span><br>
